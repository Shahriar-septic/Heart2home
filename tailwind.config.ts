  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "shimmer-flow": "shimmer-flow 3.5s ease-in-out infinite",
        "button-shine": "button-shine 3.5s cubic-bezier(0.4, 0, 0.2, 1) infinite",
        "aurora-mesh": "aurora-mesh 8s ease-in-out infinite",
        "aurora-blob-1": "aurora-blob-1 7s ease-in-out infinite alternate",
        "aurora-blob-2": "aurora-blob-2 9s ease-in-out infinite alternate",
        "aurora-blob-3": "aurora-blob-3 6s ease-in-out infinite alternate",
