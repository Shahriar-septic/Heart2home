...
export default function StickyMobileBar() {
  ...
  return (
    <div
      className={`fixed inset-x-0 bottom-0 z-30 border-t border-slate-200 bg-white/95 shadow-2xl backdrop-blur-xl pb-safe transition-transform duration-200 md:hidden ${
    ...
    >
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-2.5 px-4 py-2.5">
        <a
          ...
          className="flex min-h-[46px] items-center justify-center gap-1.5 rounded-full border-2 border-teal-600 bg-white px-3 text-sm font-bold text-teal-800 shadow-sm active:bg-teal-50"
        >
        ...
        <Link
          href="/contact"
          className="flex min-h-[46px] items-center justify-center gap-1.5 rounded-full bg-gradient-to-r from-rose-600 to-rose-500 px-3 text-sm font-bold text-white shadow-md shadow-rose-500/25 active:scale-[0.98]"
        >
